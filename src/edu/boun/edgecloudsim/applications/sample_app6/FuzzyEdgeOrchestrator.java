...
public class FuzzyEdgeOrchestrator extends EdgeOrchestrator {
	...
	String outputFile = "/Users/monikkabusto/Desktop/src/EdgeCloudSim/data/file.csv";
	...
	public int getDeviceToOffload(Task task) {
		...
		if(simScenario.equals("SINGLE_TIER")){
			...
			double manBW = (manDelay == 0) ? 0 : (1 / manDelay); /* Mbps */
        ...
        if(fis3.getVariable("offload_decision").getValue() > 50)
				...
				if(action == 0){
					...
					// offload to local server
					result = nearestEdgeHostIndex;
				} else {
