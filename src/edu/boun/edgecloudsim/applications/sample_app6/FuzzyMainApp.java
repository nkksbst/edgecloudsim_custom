...
public class FuzzyMainApp {
	...
	public static void main(String[] args) {
		...
		// the simulator runs the entire duration e.g. 30 mins x max_num_devices/step
		// the simulator runs a new instance of the orchestrator every j
		//
		for(int j=SS.getMinNumOfMobileDev(); j<=SS.getMaxNumOfMobileDev(); j+=SS.getMobileDevCounterSize())
		{
			for(int k=0; k<SS.getSimulationScenarios().length; k++) // tier type, in this case only one type : 2-tier with EO
			{
