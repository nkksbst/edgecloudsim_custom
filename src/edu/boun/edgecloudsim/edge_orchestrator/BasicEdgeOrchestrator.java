...
public class BasicEdgeOrchestrator extends EdgeOrchestrator {
	...
	// all hosts in all datacenters
	// technically in one data center, there is only one host
	@Override
  ...
  // given a task, device whether edge VM or cloud
	@Override
	public int getDeviceToOffload(Task task) {
		...
		if(!simScenario.equals("SINGLE_TIER")){
			...
			// probability of selecting cloud (almost the same as randomizing)
